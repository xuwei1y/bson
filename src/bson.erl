...
-export([objectid/3, objectid/4 , objectid_time/1]).
...
-spec objectid(unixsecs(), <<_:40>>, integer() , binary()) -> objectid().
objectid(UnixSecs, MachineAndProcId, Count , ExtraData) ->
  {<<UnixSecs:32/big, MachineAndProcId:5/binary, Count:24/big , ExtraData:1/binary>>}.
